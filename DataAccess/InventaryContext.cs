...
namespace DataAccess
{
    public class InventaryContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            {
                options.UseSqlServer("Server=BASIS-PC\\SQLEXPRESS; Database=InventoryDb; User Id=sa; Password=Administrator1; Encrypt=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WarehouseEntity>().HasData(
                ...
                new WarehouseEntity { WarehouseId = Guid.NewGuid().ToString(), WarehouseName = "Bodega US", WarehouseAddress = "1191 Wildwood Street" }
            );
